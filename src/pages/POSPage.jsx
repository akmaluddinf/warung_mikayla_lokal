          ...
          <div className='mt-3' style={{textAlign: "center"}}>
            {
              totalAmount !== 0 ? <div>
                ...
                {uangBayar > totalAmount ? <div className="badge bg-info" style={{ marginBottom: "20px", width: "100%", height: "50px", fontSize: "xx-large"}}>Kembalian: <b><span style={{color: "green"}}><CurrencyFormatter value={uangBayar - totalAmount} /></span></b></div> : uangBayar < totalAmount ? <div className="badge bg-info" style={{ marginBottom: "20px", width: "100%", height: "50px", fontSize: "xx-large"}}>Kurang: <b><span style={{color: "red"}}><CurrencyFormatter value={totalAmount - uangBayar} /></span></b></div>: <div className="badge bg-info" style={{ marginBottom: "20px", width: "100%", height: "50px", fontSize: "xx-large"}}><b><span style={{color: "green"}}>Uang Pas, Hatur Nuhun!</span></b></div>}
